...
@section('content')
    <div class="row">
        <div class="col-md-3">
            <a href="{{url('messages')}}" class="btn btn-primary btn-block margin-bottom">Back to Inbox</a>
            ...
            <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                    <ul class="nav nav-pills nav-stacked">
                        <li><a href="{{url('messages')}}"><i class="fa fa-inbox"></i> Inbox
                                <span class="label label-primary pull-right">{{$total}}</span></a></li>
