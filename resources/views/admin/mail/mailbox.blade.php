                ...
                <div class="box-body no-padding">
                    <div class="mailbox-controls">
                        ...
                        <div class="btn-group action" style="display: none">
                            <button type="button"  data-url="{{url('message')}}" class="btn btn-default btn-sm delete-BulkMail"><i class="fa fa-trash-o"></i></button>
                        ...
                        <div class="pull-right">
                            {{$messages->firstItem()}}-{{$messages->lastItem()}}/{{$total}}
                            <div class="btn-group">
                                <a href="{{$messages->previousPageUrl()}}" type="button" class="btn btn-default btn-sm"><i class="fa fa-chevron-left"></i></a>
                                <a href="{{$messages->nextPageUrl()}}" type="button" class="btn btn-default btn-sm"><i class="fa fa-chevron-right"></i></a>
                            </div>
                            <!-- /.btn-group -->
                        </div>
                        <!-- /.pull-right -->
                        ...
                        <table class="table table-hover table-striped">
                            ...
                            @foreach($messages as $message)
                                <tr>
                                    ...
                                    <td class="mailbox-name"><a href="{{url('messages/'.$message->id)}}">{{$message->name}}</a></td>
                                    <td class="mailbox-subject"><b>{{substr($message->subject, 0, 20)}}</b> - {{strip_tags(substr($message->message, 0, 50))}}...
                                    </td>
