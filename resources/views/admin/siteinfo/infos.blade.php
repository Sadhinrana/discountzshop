                    ...
                    <tr id="info{{$siteinfo->id}}">
                        ...
                        <td>
                            <div class="table-data-feature">
                                <a href="#" class="show-info btn btn-info btn-sm" data-id="{{$siteinfo->id}}"  data-facebook="{{$siteinfo->facebook}}" data-twitter="{{$siteinfo->twitter}}" data-linkedin="{{$siteinfo->linkedin}}" data-googleplus="{{$siteinfo->googleplus}}">
                                    <i class="fa fa-eye"></i>
                                </a>
                                <a href="#" class="edit-info btn btn-warning btn-sm" data-id="{{$siteinfo->id}}" data-facebook="{{$siteinfo->facebook}}" data-twitter="{{$siteinfo->twitter}}" data-linkedin="{{$siteinfo->linkedin}}" data-googleplus="{{$siteinfo->googleplus}}">
