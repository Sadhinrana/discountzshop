...
<head>
    ...
    <title>Discountzshop Admin | @yield('title')</title>
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="{{url('admin/dashboard')}}" class="logo">
            ...
            <span class="logo-lg"><b>Discountzshop Admin</b></span>
        </a>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown messages-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            @php
                                $messages = \App\Model\Mail\Message::where('is_viewed', false)->get();
                            @endphp
                    ...
                    <li class="dropdown notifications-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            @php
                                $orders = \App\Model\User\Order::whereDate('created_at', '=', \Carbon\Carbon::today())->get()->count();
                                $clients = \App\User::whereDate('created_at', '=', \Carbon\Carbon::today())->get()->count();
                            @endphp
            ...
            <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <ul class="treeview-menu">
                        <li>
                            <a href="{{url('messages')}}">Inbox
                                @if($messages->count() != 0)
                                <span class="pull-right-container">
                                  <span class="label label-primary pull-right">{{$messages->count()}}</span>
                                </span>
                                @endif
                            </a>
                        </li>
                        <li><a href="{{url('messages/create')}}">Compose</a></li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="{{url('blogs')}}"><i class="fa fa-circle-o"></i> Blog</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="{{url('countries')}}"><i class="fa fa-circle-o"></i> Country</a></li>
                        ...
                        <li><a href="{{url('products')}}"><i class="fa fa-circle-o"></i> Product</a></li>
                        <li><a href="{{url('coupons')}}"><i class="fa fa-circle-o"></i> Coupon</a></li>
                        <li><a href="{{url('auctions')}}"><i class="fa fa-circle-o"></i> Auction</a></li>
                        <li><a href="{{url('auctionapplications')}}"><i class="fa fa-circle-o"></i> Auction Application</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{url('users')}}"><i class="fa fa-circle-o"></i> Client</a></li>
                ...
                @if($role == 'Super admin')
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{url('vendors')}}"><i class="fa fa-circle-o"></i> Vendor</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="#">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{url('all_admins')}}"><i class="fa fa-circle-o"></i> Admin</a></li>
                            <li><a href="{{route('admin.register')}}"><i class="fa fa-circle-o"></i> Admin Register</a></li>
                            <li><a href="{{url('roles')}}"><i class="fa fa-circle-o"></i> Role</a></li>
                        </ul>
                    </li>
                @endif
                @endif
...
<!-- Ajax CRUD -->
<script src="{{asset('admins/dist/js/ajaxcrud.js')}}"></script>
<!-- page script -->
<script>
    $(function(){
