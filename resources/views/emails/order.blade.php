											...
											<div class="row">
													...
													<section class="woocommerce-customer-details">
														...
														<address>
															<p class="woocommerce-customer-details--phone">
																{{$order->billing->name}}<br>{{$order->billing->address}}, {{$order->billing->city}}, {{$order->billing->division}}, {{$order->billing->country}}
															</p>
												...
												<div class="col-md-6 col-sm-6 col-xs-12 mt-xs-30">
													<section class="woocommerce-customer-details">
														...
														<address>
															<p class="woocommerce-customer-details--phone">
																{{$order->shipping->name}}<br>{{$order->shipping->address}}, {{$order->shipping->city}}, {{$order->shipping->division}}, {{$order->shipping->country}}
															</p>
