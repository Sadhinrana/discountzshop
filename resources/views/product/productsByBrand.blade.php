				...
				<div class="row">
					<div class="col-md-12">
						<ul class="breadcrumbs">
							...
							<li class="trail-end">
								<a href="#" title="">{{ $brand->brandName }}</a>
							</li>
						</ul><!-- /.breacrumbs -->
					</div><!-- /.col-md-12 -->
				</div><!-- /.row -->
							...
							<div class="widget widget-brands">
								...
								<div class="widget-content">
									<form action="#" method="get" accept-charset="utf-8">
										<input type="text" name="brands" id="brands" placeholder="Category Search">
									</form>
	...
	<script>
		function getTree() {
			...
			var tree = [
				...
				{
					text: '{{$brand->brandName}} <span>({{$brand->products->count()}})</span>',
					href:"{{url('/productsByBrand/'.$brand->id)}}",
				},
				@endforeach
			];
			return tree;
