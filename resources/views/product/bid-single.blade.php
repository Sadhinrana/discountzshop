...
@section('content')
            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="breadcrumbs">
                        ...
                        <li class="trail-end">
                            <a href="#" title="">Bid Application</a>
                        </li>
                    </ul><!-- /.breacrumbs -->
                </div><!-- /.col-md-12 -->
            </div><!-- /.row -->
    ...
    <main id="shop">
        <div class="container">
            <div class="row">
                <div class="count-down" data-countdown="{{$bid->valid_until}}">

                </div><!-- /.count-down -->
                <div class="pull-right"><h1>{{ $bid->product->productName }}</h1></div>
            </div><!-- /.row -->
            <div class="row">
                @if($bid->valid_until >= \Illuminate\Support\Carbon::now())
                ...
                <div class="table-content table-responsive">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                        @foreach($bid_applications as $bid_application)
                            <tr>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ url('bidapplications') }}" id="bid">
