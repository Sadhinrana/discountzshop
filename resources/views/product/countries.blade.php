					...
					<div class="col-md-12">
						...
						<div class="brands-list grid">
						  @foreach($countries as $country)
							<div class="brands-item ipsotope {{strtolower(substr($country->name, 0, 1))}}">
								<a href="{{URL::to('/productsByCountry/'.$country->id)}}" class="box-cat" title="">
									<span class="menu-img"><img src="{{asset('storage/images/country/flag/'.$country->flag)}}" style="height: 50px;width: 75px"  alt=""></span>
									<hr />
									<div class="cat-name">
										{{$country->name}}
									</div>
									<div class="numb-product">
									{{$country->products->count()}} Product
									</div>
								</a>
