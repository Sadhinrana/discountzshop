...
;(function($) {
   ...
   'use strict'
        ...
        var showSuggestions = function() {
            $( ".top-search form.form-search .box-search" ).each(function() {
                $( "form.form-search .box-search input" ).on('keyup', (function() {
                    ...
                    $.ajax({
                         type:"GET",
                         url:base_url + "/getSuggestedProducts/" + $( "input[name='search']" ).val(),
                         success : function(results) {
                             ...
                             $.each(results, function (index, value) {
                                 ...
                                 $("#productSug").append('<li>\n' +
                                     ...
                                     '\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class="name">\n' +
                                     '\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"/products/'+value.id+'\" title=\"\">'+value.productName+'</a>\n' +
                                     '\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\n' +
                                     '\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class="price">\n' +
                                     '\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class="sale">\n' +
                                     '\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t৳'+ (value.salePrice - value.salePrice*value.discount_value/100) +'\n' +
                                     '\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</span>\n' +
                                     '\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class="regular">\n' +
                                     '\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t৳'+value.regularPrice+'\n' +
                                     '\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</span>\n' +
        ...
        var CategoriesIsotope = function() {
            if ( $().isotope ) {
